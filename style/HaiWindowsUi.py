...
from PySide6.QtWidgets import (QApplication, QHBoxLayout, QHeaderView, QLabel,
    ...
    QStackedWidget, QToolButton, QTreeView, QTreeWidgetItem,
...
"}")
        ...
        self.dir_tree = QTreeView(self.page)
        ...
        self.file_count = QLabel(self.bottom_right_menus)
        self.file_count.setObjectName(u"file_count")
        self.file_count.setMouseTracking(True)

        self.bottom_right_menus_layout.addWidget(self.file_count)
